"""
Django settings for raiseticket project.
...
SECRET_KEY = 'uz15c2wbdv#)z9hp1--s+*@gf48u2elgm!z3&y%1l*oll7l(ax'
...
WSGI_APPLICATION = 'raiseticket.wsgi.application'
...
EMAIL_HOST_PASSWORD = '********' #change password
